  ...
  return (
    <View className="bg-white flex-1">
        ...
        <SafeAreaView className="flex-row justify-between items-center w-full absolute mt-4">
            ...
            >
                <AntDesign name="left" size={wp(7)} color="white" />
            </TouchableOpacity>
            <TouchableOpacity
                ...
                style={{backgroundColor: 'rgba(255,255,255,0.5)'}}
            >
                <AntDesign name="heart" size={wp(7)} color={isFavourite ? `${theme.text}` : 'white'} />
            </TouchableOpacity>
        </SafeAreaView>

        {/* title - description - bookingButton */}
        <View 
        ...
        >
            <ScrollView showsVerticalScrollIndicator={false} className="space-y-5">
                <View className="flex-row justify-between items-center">
                    <Text style={{fontSize: wp(7)}} className="font-bold text-neutral-700 flex-1">
                        {item?.title}
                    </Text>
                ...
                <View className="flex-row justify-between mx-1">
                    ...
                    <View className="flex-row space-x-2 items-start">
                            <FontAwesome5 name="map-marker-alt" size={wp(7)} color="#f87171"/>
                        <View className="flex space-y-2 ">
            ...
            <TouchableOpacity
            style={{backgroundColor: theme.text, width: wp(50), height: wp(15)}}
